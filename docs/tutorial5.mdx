...
You would not normally have this many settings properties in an app that you want to persist locally (or remotely). In those cases, this approach is quite simple and convenient. In this particular case though, well maybe not with this large number of properties. There are **168** individual theming property key-value pairs managed by the same controller. This is a large number controlled properties. However, the setup is simple to make, even if it as mentioned is quite repetitive.
