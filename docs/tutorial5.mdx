...
In case you somehow missed it, you can try the **FlexColorScheme Themes Playground** example as a Flutter [web app here](https://rydmike.com/flexcolorscheme/themesplayground-v5).
