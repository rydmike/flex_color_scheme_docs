...
<Info>Version 7 of **FlexColorScheme** is now available on [pub.dev](https://pub.dev/packages/flex_color_scheme). It supports new Material 3 features in [Flutter 3.7](https://medium.com/flutter/whats-new-in-flutter-3-7-38cbea71133c). A new version of [Themes Playground](https://rydmike.com/flexcolorscheme/themesplayground-v7) has also been released. Read more in the [what's new](/whats_new) chapter. This documentation site is still undergoing updates to cover all the new features. When completed, this notice will be removed.
</Info>
