...
<Info>**FlexColorScheme** package 8.0.0 has been published. This is a **BIG** update with breaking changes and many new features. For more information, see the [**What's new**](/whats_new) chapter and the [Migration guide](/migrating) summary, or read the full detailed [Changelog](https://pub.dev/packages/flex_color_scheme/versions/8.0.0/changelog) on pub. This documentation site has not yet been updated to cover the new features in version 8, but package API docs are upp to date. When site documentation updates are completed this release note will be updated to say so.</Info>
