...
<Info>**Version 7.2** is now available on [pub.dev](https://pub.dev/packages/flex_color_scheme). It supports new Material-3 features in [Flutter 3.10](https://medium.com/flutter/whats-new-in-flutter-3-10-b21db2c38c73) and has more platform adaptive theming features. A new version of the [Themes Playground](https://rydmike.com/flexcolorscheme/themesplayground-v7-2) companion app has also been released. Read more in the [what's new](/whats_new) chapter.</Info>
