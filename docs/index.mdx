...
<Info>**FlexColorScheme** package 8.0.0 has been published. This is a big update with some breaking changes and many new features. For more information, see the [What's new](/whats_new) chapter and the [Migration guide](/migrating) summary, or read the full detailed [changelog](https://pub.dev/packages/flex_color_scheme/versions/8.0.0/changelog) on pub. This documentation site has not yet been fully updated to cover all the new features, but package API docs are upp to date, as is the [Playground](https://rydmike.com/flexcolorscheme/themesplayground-latest/). When documentation updates are complete this release note will be updated to reflect this.</Info>
