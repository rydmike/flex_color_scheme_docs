...
You can also opt in on using Material 3. The Material 3 mode component sub-theming is far less opinionated, using mostly Material 3 defaults. In Flutter 3.7 and later, using Material 3 design is ready for production use. Some minor issues do still exist, please refer to the FlexColorScheme docs [known issues](https://docs.flexcolorscheme.com/known_issues) chapter for more information on the status of known theming issues in Flutter.
