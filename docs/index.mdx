...
<Info>**Version 7.3** is available on [pub.dev](https://pub.dev/packages/flex_color_scheme). It supports new, fixed and changed Material-3 features in [Flutter 3.13](https://medium.com/flutter/whats-new-in-flutter-3-13-479d9b11df4d). A new version of the [Themes Playground](https://rydmike.com/flexcolorscheme/themesplayground-latest) companion app has also been released. More info in the [what's new](/whats_new) chapter.</Info>
