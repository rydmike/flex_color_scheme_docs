...
## Release Notice V5.0.0-dev.3

**This documentation has not yet been fully updated to version 5,
it is still a work in progress!**

* **Q:** Will there be significant changes from 5.0.0-dev.3 to 5.0.0 stable?
...
* **A:** Documentation, meaning this site should be updated and ready. Chapters
  that have not yet been updated to version 5 have a **TODO** note in them. One chapter
  remaining and lots of review and proof reading.
