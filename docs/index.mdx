...
versions. The companion app, the [**Themes Playground**](https://rydmike.com/flexcolorscheme/themesplayground-v5)
...
* The default bundled example **Hot Reload Playground** has also been updated.
  Its comments contain a lot of verbose documentation that can guide in getting started too.
