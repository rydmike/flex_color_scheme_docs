...
<table>
  <tr>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-01.png?raw=true" alt="Four1 light" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-01.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-02.png?raw=true" alt="Four2 light" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-02.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-03.png?raw=true" alt="Four3 light" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-03.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-04.png?raw=true" alt="Four3 light" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-04.png?raw=true)</td>
  </tr>
  <tr>
 ...
 <table>
  <tr>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-01.png?raw=true" alt="Four1 dark" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-01.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-02.png?raw=true" alt="Four2 dark" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-02.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-03.png?raw=true" alt="Four3 dark" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-03.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-04.png?raw=true" alt="Four3 dark" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-04.png?raw=true)</td>
  </tr>
  <tr>
    <td colspan="7"> **_Using three built-in schemes, plus a custom color scheme as application light theme options_** </td>
  </tr>
...
that the result is keeping a bit more of the original design intent. Still the
colors are quite a bit off. Also in this example when secondary and tertiary is
used, it is using the chroma from these colors, but limited to same max values
as the `ColorScheme.fromSeed` algorithm uses for its single color seed.
The color math in the Material 3 Tonal Palette generation is very sophisticated,
but in Flutter SDK very little of it is exposed. FlexColorScheme opens up much
more of its capabilities via easy to use APIs, that let's you change these
key color chroma limits and even which tone is what for color in the ColorScheme.
This can make generated schemes more vivid or muted, we will look at this in the
last tutorial example.

<table>
    <tr>
    <td><b>&nbsp;Mallard green</b></td>
    <td>&nbsp;</td>
    <td><b>&nbsp;Seeded from its primary color</b></td>
    <td>&nbsp;</td>
    <td><b>&nbsp;From its primary and secondary</b></td>
    <td>&nbsp;</td>
    <td><b>&nbsp;From primary, secondary and tertiary</b></td>
  </tr>
  <tr>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-05.png?raw=true" alt="Four1 light" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-05.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-06.png?raw=true" alt="Four2 light" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-06.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-07.png?raw=true" alt="Four3 light" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-07.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-08.png?raw=true" alt="Four3 light" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-l-08.png?raw=true)</td>
  </tr>
    <tr>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-05.png?raw=true" alt="Four1 dark" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-05.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-06.png?raw=true" alt="Four2 dark" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-06.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-07.png?raw=true" alt="Four3 dark" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-07.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-08.png?raw=true" alt="Four3 dark" width="200"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-tut3-d-08.png?raw=true)</td>
  </tr>
  <tr>
