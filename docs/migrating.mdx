...
No migration needed from version 8.0. You may want to check the [changelog](https://pub.dev/packages/flex_color_scheme/changelog) for info on some new features and minor changes.
