...
## Migrating to version 8.4

No migration needed from version 8.3. You may want to check the [changelog](https://pub.dev/packages/flex_color_scheme/changelog) for info on fixes, new features and **Themes Playground** changes.

## Migrating to version 8.3

No migration needed from version 8.2. You may want to check the [changelog](https://pub.dev/packages/flex_color_scheme/changelog) for info on fixes, some new features and minor **Themes Playground** changes.

## Migrating to version 8.2

No migration needed from version 8.1. You may want to check the [changelog](https://pub.dev/packages/flex_color_scheme/versions/8.2.0/changelog) for info on some new features and minor changes.

## Migrating to version 8.1

No migration needed from version 8.0. You may want to check the [changelog](https://pub.dev/packages/flex_color_scheme/versions/8.1.0/changelog) for info on some new features and minor changes.
...
No migration needed from version 7.0. Upgrade **Flutter** to min version **3.10.0** and **FlexColorScheme** to version **7.1.0** or higher.
