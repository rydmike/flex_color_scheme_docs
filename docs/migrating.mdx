...
No migration needed from version 7.1. You may want to check the [change-log](https://pub.dev/packages/flex_color_scheme/changelog) for info on some minor default and style breaking changes, especailly when using Material-2.

## Migrating to version 7.1

No migration needed from version 7.0. Just upgrade **Flutter** to min version **3.10.0** and **FlexColorScheme** to min version **7.1.0**.
