...
Flurdle is a beautiful supercharged Flutter Wordle variant. Get it on from the [AppStore](https://apps.apple.com/app/id1618767506) or just play it online using the [web version](https://flurdle.momar.me).
