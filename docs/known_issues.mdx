...
Summary of reported amount Flutter theming issues, that impact or have impacted theming in Flutter, as well as features in **FlexColorScheme** and **Themes Playground**.

| Status               | Amount    |
|----------------------|-----------|
| No fix               | 21 issues |
| Fixed in Master/Beta | 8 issues  |
| Fixed in stable      | 19 issues |

_Last status review July 6, 2023_

## No Fix

Issues below have not been fixed yet, or if they have a fix, they have not yet been merged into the Flutter master channel.
...
The `Slider` and `RangeSlider` components have a large number of known issues. They are however, typically not related to theming. Only a few are, like e.g. `RangeSlider` not having M3 style value indicator. For more information, see umbrella issue [#125329](https://github.com/flutter/flutter/issues/125329).


### Elevation overlay color limitation in M2 dark mode
...
<Error>Applies to Flutter stable 3.10.</Error>
<Success>Has fix [PR #127465](https://github.com/flutter/flutter/pull/127465) in master, but not yet in stable 3.10.</Success>
...
<Error>Applies to Flutter stable 3.10.</Error>
<Success>Has fix [PR #127197](https://github.com/flutter/flutter/pull/127197) in master, but not yet in stable 3.10.</Success>
...
<Error>Applies to Flutter 3.7 and 3.10.</Error>
<Success>Has fix [PR #128049](https://github.com/flutter/flutter/pull/128049) in master, but not yet in stable 3.10.</Success>
...
<Success>Has fix [PR #124673](https://github.com/flutter/flutter/pull/124673) in master, but not yet in stable 3.10.</Success>
...
<Error>Applies to Flutter 3.7 and 3.10.</Error>
<Success>Has fix [PR #128584](https://github.com/flutter/flutter/pull/128584) in master, but not yet in stable 3.10. It is uncertain if the fix can be used with themes for each Chip variant, it will work on Chip property level though.</Success>
...
<Success>Has a **fix** [PR #123293](https://github.com/flutter/flutter/pull/122542) in master, not yet landed in stable 3.7 or 3.10.</Success>
...
This list is included to shows what older versions of Flutter, past theming fixes do not apply to.
Prefer using latest stable version of Flutter to get all fixes listed below.
...
### Typography dynamically switching causes a crash
<Success>Fixed in Flutter 3.7.</Success>
<Error>Applies to Flutter 3.3 and earlier.</Error>
...
### TextField in Material 3 has wrong hovered and focused styles
