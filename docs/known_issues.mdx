...
Chip does not conform to Material3 design spec when useMaterial3 is enabled. See [issue #115364](https://github.com/flutter/flutter/issues/115364) for details. No known corrective actions yet (Nov 18, 2022).

## Flutter SDK: NavigationBar ink ripple does not follow M3 spec

The M3 `NavigationBar` has a Material 2 type ink effects also when opting in on Material 3. This is not according to Material design specification. See issues [113870](https://github.com/flutter/flutter/issues/113870) and [#114618](https://github.com/flutter/flutter/issues/114618) for more information.
...
## Flutter SDK: TextField in Material 3 mode has wrong hovered and focused styles
...
issue [#103864](https://github.com/flutter/flutter/issues/103864) for more information. If it is done and the error ignored, an app doing so eventually becomes unstable.
