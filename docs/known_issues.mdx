...
The chapter lists known issues. Currently all known issues impacting FlexColorScheme are rooted in
Flutter SDK issues and cannot be fixed in the package. These issues are being tracked and status
...
This regression only aplies in master channel and impacts AppBar icon colors when using Material 3
...
Due to Flutter SDK [issue #100027](https://github.com/flutter/flutter/issues/100027)
