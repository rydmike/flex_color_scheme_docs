...
<Error>Applies to Flutter stable 3.10.</Error>
<Success>Has fix [PR #127465](https://github.com/flutter/flutter/pull/127465) in master, but not yet in stable 3.10. 
Not yet in beta, may not land in next stable, remains to be seen.</Success>
...
Fix is also in beta and will land in next stable. Unverified if the fix is 100% correct based on M3 Web spec and all the Chip variants elevations, but it is definitely better.</Success>
...
Fix is also in beta and will land in next stable. 
