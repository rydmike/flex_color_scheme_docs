...
The fix is not very useful and is therefore not here considered fixed, see [comment in PR 128950](https://github.com/flutter/flutter/pull/128950#issuecomment-1657177393) which is further elaborated in additional comments in same PR, as well as in issue [#131666](https://github.com/flutter/flutter/issues/131666).</Warning>
