...
<Error>Applies to Flutter 3.7 and earlier in cases where the widget with a spec deviation supported M3 in earlier versions.</Error>

The following Material-3 themes in Flutter 3.7 have minor deviation errors from their Material-3 specification.
...
<Warning>Applies to Flutter 3.7 and earlier.</Warning>
...
<Success>Only occurred in master, appears to not have landed in any Flutter stable version</Success>
...
The [PR #113776](https://github.com/flutter/flutter/pull/113776) in the master channel fixes the issue. This issue only occurred in the master channel, because M3 mode support for `TextField` did not exist in the Flutter stable 3.3 channel. This issue never regressed to the stable channel.
...
<Success>FlexColorScheme 7.0.0 has removed past used workaround it used to correct the issue on Android 11. It also again enabled the divider option in its `FlexColorScheme.themedSystemNavigationBar`.</Success>
