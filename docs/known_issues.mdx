...
This regression only applies to master channel and impacts `AppBar` icon colors when using Material 3 [#107305](https://github.com/flutter/flutter/issues/107305). It has not landed in stable channel *Flutter 3.0.5*, but if you use master channel it is something to be aware of with certain versions of it. This issue was fixed via [PR #108332](https://github.com/flutter/flutter/pull/108332) and can no longer be observed in *master, 3.1.0-0.0.pre.2108* or later versions.
