...
The `Chip` does not conform to Material3 design spec when `useMaterial3` is enabled. See umbrella issue [#115364](https://github.com/flutter/flutter/issues/115364) for details. Most of the theme related issues listed in the umbrella issue have been fixed in master channel. See status of listed individual Chip issues.
