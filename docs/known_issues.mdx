...
_Last status review July 25, 2023_
...
The Checkbox component has a theme and styling regression when comparing Flutter stable 3.10.6 (and earlier versions) in latest master channel. The issue has also regressed into latest **beta channel 3.13.0-0.2.pre** and may potentially land in next stable Flutter version. 
