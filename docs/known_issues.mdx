...
Issues below have not fix landed even master yet. 
...
Issues below have a fix that has been **merged** in latest Flutter master channel, but it has not landed in any version of stable Flutter 3.7.
