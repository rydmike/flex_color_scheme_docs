...
If you change the `NavigationBar` from M3 default value of 80dp, the ink level moves up or down with same amount as the devations fro the default 80dp height. See issue report and illustration [here FCS #114](https://github.com/rydmike/flex_color_scheme/issues/114) as well as in Flutter SDK issue [#117420](https://github.com/flutter/flutter/issues/117420). The issue is cause by a regression in Flutter 3.7. It does not exist in Flutter 3.3 and earlier. It is also fixed in current master channel via [fix PR 117473](https://github.com/flutter/flutter/pull/117473).  
