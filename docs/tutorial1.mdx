...
The only code highlights may be shown below, for the complete code for
the example see [here](https://github.com/rydmike/flex_color_scheme/tree/master/example/lib/example1).
