...
> Only code highlights might be shown below, the complete code for the example is [here](https://github.com/rydmike/flex_color_scheme/tree/master/example/lib/example1).
