...
[<Image src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-M3-v-M2-textstyles.png?raw=true" caption="Comparing M3 and M2 Text Styles" alt="M3 vs M2 text style"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-M3-v-M2-textstyles.png?raw=true)
