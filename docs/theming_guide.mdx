...
FlexColorScheme with no component themes and with them. Hunting for the color
default in the Flutter SDK source code is possible, but it is a bit tedious.
