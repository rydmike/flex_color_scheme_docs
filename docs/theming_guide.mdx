...
Based on my early assessment of the Theme extensions, it completely changes what you can do with theming in Flutter, you can finally build that real  design system you always wanted to build to speed up your development and ensure easy to reuse design and consistency.
