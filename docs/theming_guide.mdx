...
The `ColorScheme` used to be a a lot simpler prior to Flutter 2.10. To get more
understanding of how the color system that uses the colors in your color schemes
work, please refer to the [Material 3 guide](https://m3.material.io/styles/color/overview).

This tweet slide series is a nice easy quick intro the the wondrous world of
