...
Nor is this guide about how to make beautiful theme designs. Its focus is on the technicalities of how to actually define your `ThemeData` object in Flutter, how to make it work for you. In the ["Roads to ThemeData"](/theming_roads) chapter, we look at different options for producing a `ThemeData` object, and analyze what their differences are.

If you prefer to watch a live recorded talk about these topics, there is one from Flutter Nordics meetup May 17th, 2022. Here you can find links to the recording of my live streamed talk [**Flutter App Theming**](https://rydmike.com/blog_m3_talk). In the talk I present similar topics as those explained in this chapter, and in the chapter ["Roads to ThemeData"](/theming_roads). 
