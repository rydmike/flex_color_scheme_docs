...
**TODO: Updated ALL images wot version 5 and add the 4 new schemes**
...
"only" 36 new and different from standard Flutter ready-made light and dark
color scheme pairs. The color scheme "Amber blue" is intended as a
...
The tutorial based on example 1 to 5, show how you can make and use your own
custom color schemes with FlexColorScheme. Maybe the built-in examples will
inspire your creative side to define your own schemes. The tutorials walks
you through how to define your own color schemes and make themes based on them.
...
however not necessary to use them to get the benefits of FlexColorScheme.
