...
<Info>In the Flutter master channel, a `ListenableBuilder` has been added via [PR #116543](https://github.com/flutter/flutter/pull/116543), but it is not available in stable Flutter 3.7. It will most likely land in the next stable release.</Info>
