...
The Flutter **FlexColorScheme** package is published on [pub.dev](https://pub.dev/packages/flex_color_scheme) and has its open source code in the GitHub [flex_color_scheme](https://github.com/rydmike/flex_color_scheme) repository. To use it in your **Flutter** project, add the `flex_color_scheme` package to `pubspec.yaml`:
