...
<table>
  <tr>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-counter-01.png?raw=true" alt="Counter light" width="250"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-counter-01.png?raw=true)</td>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-counter-02.png?raw=true" alt="Counter dark" width="250"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-counter-02?raw=true)</td>
  </tr>
  <tr>
    <td colspan="2"> **_FlexColorScheme applied on the standard Flutter Counter Template (click images to open hires version)_** </td>
  </tr>
</table>
