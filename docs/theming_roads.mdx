...
<Info>This chapter has not yet been updated to fully cover some minor chnages brought by Flutter 3.10 when using Material-3. When it has been updated, this notice will be removed.</Info>
