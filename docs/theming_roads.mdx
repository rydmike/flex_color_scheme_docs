...
where I added a brief version of above findings as well.

What happens in the next new stable release of Flutter regarding all this
remains to be seen. Looking at all the work in the master channel I see a lot of improvements,
but it remains to be seen what lands in stable when.
