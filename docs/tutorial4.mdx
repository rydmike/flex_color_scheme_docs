...
Scroll down in the app to see the theme showcase further below. It presents the theme with common Material UI widgets. You can try this example as a Flutter web app [using V6 here](https://rydmike.com/flexcolorscheme/allthemes-v6) and [V7 here](https://rydmike.com/flexcolorscheme/allthemes-v7).
