...
A future version of the Themes Playground application may add these "resets", to selected component themes, but you can add them manually to any component theme as shown above.
