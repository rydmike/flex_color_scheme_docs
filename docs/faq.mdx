...
If you want to make modifications to a component theme that FlexColorScheme already created, **and** you want to keep some of the properties it defined, the steps are bit more involved than resetting it back to defaults.
