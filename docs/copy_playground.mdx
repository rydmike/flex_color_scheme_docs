...
app where you want to try a theme. You may however find the **Copy Playground**
helpful, since it includes presentation of all ColorScheme and Theme colors,
as well as commonly used Flutter Material UI widgets. This makes it easy to see and
...
Material 2 design guide theme created using `ThemeData.from` the Material 2
guide light and dark theme examples.
...
**Pink Sakura**, that we select as our scheme for the generated `ColorScheme`.
...
pretty magical. In the Playground we use the Widget Showcase to compare
the colors and UI widget styles in the Themes Playground, and in the
Copy Playground we can see and verify that they are the same.
