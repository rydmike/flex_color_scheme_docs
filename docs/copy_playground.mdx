...
You can of course test with a plain vanilla counter app too, or any app where you want to try a theme. You may, however, find the **Copy Playground** helpful. It includes presentation of all ColorScheme and Theme colors, as well as commonly used Flutter Material UI widgets. This makes it easy to see and verify that the theme looks as intended with a large number of UI elements.
