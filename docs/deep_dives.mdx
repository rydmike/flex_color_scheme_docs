...
<table>
  ...
  <tr>
    <td colspan="3">_Designed dark **Deep blue see** theme versus computed dark theme from its light theme._</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td colspan="3">_Designed dark **Aqua blue** theme versus computed dark theme from its light theme._</td>
  </tr>
</table>
...
Dark-mode is nice, and with `FlexColorScheme` you can go even darker, go **true black** with the flick of a
...
If you use branded surfaces with true black mode enabled, you will notice that the surface blends have a lower impact,
only at high blend levels does it have a visible effect. This is by design to keep most surfaces totally or
very close to black when true black is combined with surface blends. If you really want complete black
for all surfaces and backgrounds, then avoid combining true black mode with primary branded surfaces. On the other hand it
still makes a darker theme than normal dark theme, which can look nice. It may also eliminate the scrolling issue, since
all background colored pixels are not fully off in the true black modes when you use high blend levels.
...
<table>
  <tr>
    <td>[<img src="https://rydmike.com/assets_fcsv4/fcs_phone_ex5cd.png?raw=true" alt="ColorScheme example 5c dark" width="250"/>](https://rydmike.com/assets_fcsv4/fcs_phone_ex5cd.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://rydmike.com/assets_fcsv4/fcs_phone_ex5bd.png?raw=true" alt="ColorScheme example 5b dark" width="250"/>](https://rydmike.com/assets_fcsv4/fcs_phone_ex5bd.png?raw=true)</td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td>[<img src="https://rydmike.com/assets_fcsv4/fcs_phone_ex5ad.png?raw=true" alt="ColorScheme example 5 dark" width="250"/>](https://rydmike.com/assets_fcsv4/fcs_phone_ex5ad.png?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://rydmike.com/assets_fcsv4/fcs_phone_ex5ad-true-black.png?raw=true" alt="ColorScheme example 5 true black" width="250"/>](https://rydmike.com/assets_fcsv4/fcs_phone_ex5ad-true-black.png?raw=true)</td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td>[<img src="https://rydmike.com/assets_fcsv4/FlexSchemeAppBar.gif?raw=true" alt="AppBar StatusBar" width="250"/>](https://rydmike.com/assets_fcsv4/FlexSchemeAppBar.gif?raw=true)</td>
    <td>&nbsp;</td>
    <td>[<img src="https://rydmike.com/assets_fcsv4/FlexSchemeNavBar.gif?raw=true" alt="SysNavBar Style" width="250"/>](https://rydmike.com/assets_fcsv4/FlexSchemeNavBar.gif?raw=true" alt="SysNavBar Style" width="250"/>)</td>
  </tr>
  <tr>
...
* There is a known issue in Flutter SDK [issue #100027](https://github.com/flutter/flutter/issues/100027)
