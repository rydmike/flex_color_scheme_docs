...
This chapters provides more details and explanations of some features in
FlexColorScheme. This chapter will receive updates and new deep dives as needed
in future updates, based on questions user of **FlexColorScheme** have.

This chapter may contain images and animation from older versions
of **FlexColorScheme**, they are used wne the principles presented are still
the same and the actual image matter less. Future version of this chapter
may update the images based on current version of FlexColorScheme if it is
needed to improve the concept explanations.
...
Here are few more images of the primary color branded version, when
...
when using high blend level with the **Red red wine** color scheme.
