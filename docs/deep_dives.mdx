...
Example 1 to 4 do not use the transparent or themed system navigation bar,
but if you if you build example 5 on an Android device you can try and see the partially and even
...
theme that can be copied, since the required setup is not
