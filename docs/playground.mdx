...
<table>
  <tr>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-01-pageview-3.gif?raw=true" alt="page view demo"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-01-pageview-3.gif?raw=true)</td>
  </tr>
  <tr>
    <td> **_Themes Playground - Topic based page view, responsiveness demo (click to open in full size)_** </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-02-masonryview-2.gif?raw=true" alt="masonry view demo"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-02-masonryview-2.gif?raw=true)</td>
  </tr>
  <tr>
    <td> **_Themes Playground - Masonry grid view with collapsible topic panels, responsiveness demo (click to open in full size)_** </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>[<img src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-03-radius-change-1.gif?raw=true" alt="border change radius demo"/>](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-03-radius-change-1.gif?raw=true)</td>
  </tr>
  <tr>
    <td> **_ThemeData animated change continues a bit after slider change stops, plus realtime code update (click to open in full size)_** </td>
  </tr>
</table>
