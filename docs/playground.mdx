...
### Version 7 beta
A beta release of FlexColorScheme 7.0.0 is available on pub.dev as a pre-release [7.0.0-dev.3](https://pub.dev/packages/flex_color_scheme/versions/7.0.0-dev.3). It supports new Material 3 features in [Flutter stable 3.7](https://medium.com/flutter/whats-new-in-flutter-3-7-38cbea71133c). Here you can use [Themes Playground V7 final beta](https://rydmike.com/flexcolorscheme/themesplayground-v7). Read more about it in the [what's new](/whats_new) chapter.
