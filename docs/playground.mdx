...
**TODO: Add image examples of copy code**
...
**TODO: Add image examples of disabled controls**
...
**TODO: Add image examples of border radius default values **
...
border radius has not been specified with its slider. If you set a global
default radius, they will show that values as their default border radius,
and also state it comes from the global border radius default.
...
Small details like this, helps you keep on on top of what default values are
when and controls are only available when they actually have an impact on
the resulting theme.

## Input Colors

**TODO: Explain and show the input color concept**
