...
settings until you find something you like. The GifSCreen recording below
show the surface blend modes at same mid level and then one of the surface
modes form no blend level to maximum blend level.
...
<Tabs
  ...
  <TabItem value="blend-surface">
    ...
    alt="Unavailable controls" zoom />](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-28-blend-light-02.gif?raw=true)
  </TabItem>
  <TabItem value="blend-onColor">
    ...
    alt="Available controls" zoom />](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-29-on-blend-light-02.gif?raw=true)
  </TabItem>
</Tabs>
...
alt="custom theme" zoom />](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-30-custom-colors-02.gif?raw=true)
...
<Image src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-31-copy-scheme?raw=true"
    caption="Copy active ColorScheme."
    alt="Tweet surface blends 2020" zoom />](https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-pg-31-copy-scheme.png?raw=true)
