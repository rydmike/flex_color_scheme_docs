...
<Tabs
  ...
  <TabItem value="phone-scrolling">
    <Image zoom src="https://raw.githubusercontent.com/rydmike/flex_color_scheme_docs/master/docs/images/playground-phone.png" alt="phone view scrolling" caption="View 1 - Phone sized single page view - scrolling"/>
  </TabItem>
  <TabItem value="phone-swiping">
    <Image zoom src="https://raw.githubusercontent.com/rydmike/flex_color_scheme_docs/master/docs/images/playground-phone.png" alt="phone view swiping" caption="View 1 - Phone sized single page view - swiping to next panel"/>
  </TabItem>
</Tabs>
...
<Tabs
  ...
  values={[
    ...
    {label: 'Tablet popup menu, value: 'tablet-compact-popup'},
...
<Tabs
  ...
  values={[
    {label: 'Desktop compact UI, top colors', value: 'desktop-compact'},
    {label: 'Desktop large UI, top colors', value: 'desktop-large'},
  ]}>
...
<Tabs
  ...
  values={[
    {label: 'Desktop compact UI, side colors', value: 'desktop-side-compact'},
    {label: 'Desktop large UI, side colors', value: 'desktop-side-large'},
    {label: 'Desktop large UI, expanded menu, side colors', value: 'desktop-side-large-menu'},
  ]}>
  <TabItem value="desktop-side-compact">
    <Image zoom src="https://raw.githubusercontent.com/rydmike/flex_color_scheme_docs/master/docs/images/playground-side-colors-side-compact.png" alt="playground side colors side compact" caption="View 3 - Compact UI on desktop sized media, colors on the side"/>
  </TabItem>
  <TabItem value="desktop-side-large">
    <Image zoom src="https://raw.githubusercontent.com/rydmike/flex_color_scheme_docs/master/docs/images/playground-side-colors-side-expanded.png" alt="playground side colors side expanded" caption="View 3 - Large UI on desktop sized media, colors on the side"/>
  </TabItem>
  <TabItem value=desktop-side-large-menu">
    <Image zoom src="https://raw.githubusercontent.com/rydmike/flex_color_scheme_docs/master/docs/images/playground-side-colors-side-expanded-menu.png" alt="playground side colors side expanded" caption="View 3 - Large UI on desktop sized media, colors on the side, menu expanded"/>
  </TabItem>
</Tabs>
