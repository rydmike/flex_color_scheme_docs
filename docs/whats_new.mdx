...
To migrate to the new version at least check out the summary in the [**Migration Guide**](/migrating). For a detailed log of all changes please see [CHANGELOG on pub.dev](https://pub.dev/packages/flex_color_scheme/versions/8.0.0-dev.1/changelog) on pub.
