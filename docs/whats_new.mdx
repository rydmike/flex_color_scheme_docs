...
including using Material 3 key color based seeded ColorSchemes. It also has
it own usage [guide](/playground). The updated **Copy Playground Theme** template,
can be used to test themes using copy-pasted setup code from the Themes Playground app.
...
features and principles are the same in the tweet.
