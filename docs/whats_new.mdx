...
* [5) Themes Playground](https://rydmike.com/flexcolorscheme/themesplayground-v5)
  ...
  The new version 5 of the [**Themes Playground**](https://rydmike.com/flexcolorscheme/themesplayground-v5)
...
* The **Copy Playground Theme** template, can be used to test themes
  using copy-pasted setup code from the Themes Playground app. It has also
  also been updated.
...
where Flutter Dash explains all the new features in a slide series.
