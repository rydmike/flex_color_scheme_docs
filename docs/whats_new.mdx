...
The example apps have all also been updated. The new live web builds of them are available here:
...
For a guided tour of what is new, check out this Tweet and its thread
...
The slide series is using the Themes Playground app from the 5.0.0-dev.1 release. The app is a lot
fancier looking now, but all the FlexColorScheme V5 features and principles are the same.
