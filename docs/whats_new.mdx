...
**TODO: Consider adding some more info about new features**

The what's new chapter covers latest two major releases. Older what's new chapters are purged
...
* The default example **Hot Reload Playground** has also been updated.
  Its comments contain a lot of verbose documentation that serve as a getting started
  guide as well.
* The **Copy Playground Theme** template, that can be used to test themes
  using copy-pasted setup code from the Themes Playground app, is also updated.


You can check out this Tweet and its thread
[here](https://twitter.com/RydMike/status/1511166732496429058?s=20&t=MV6gzNO0p2lZhr-JgQycIg) to find a long thread where Flutter
Dash explains all the new features in a slide series.
...
### New Color Schemes in Version 5

There are of course new built-in color schemes. Four of them is the de-facto
norm for major new releases and the new color schemes in version 5 are:
...
| <Image src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-d-37.png?raw=true" alt="Dash light" width="220" zoom/> | <Image src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-d-38.png?raw=true" alt="M3 baseline" width="220" zoom /> | <Image src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-d-39.png?raw=true" alt="Verdun green" width="220" zoom /> | <Image src="https://github.com/rydmike/flex_color_scheme_docs/blob/master/docs/images/fcs-v5-d-40.png?raw=true" alt="Dell genoa" width="220" zoom /> |
...
<table>
  ...
  <tr>
    <td colspan="7"> **_Examples of FlexColorScheme themes (click images to open hires version)_** </td>
  </tr>
</table>
...
### New Color Schemes in Version 4
