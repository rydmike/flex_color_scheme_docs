...
This chapter features recent news and updates in **FlexColorScheme**. For a more complete and older updates, please refer to the package [changelog](https://pub.dev/packages/flex_color_scheme/changelog). This documentation site was launched together with version 5.0.0. It is constantly updated and improved. Suggestions and corrections to improve the documentation are welcome contributions.
