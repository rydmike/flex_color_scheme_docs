...
The what's new chapter covers the laast two major releases. Older what's new chapters are purged
...
<table>
  ...
  <tr>
    <td colspan="7"> **_New FlexColorScheme themes in version 5 (click images to open hires version)_** </td>
  </tr>
</table>
