...
This chapter features recent news and updates in **FlexColorScheme**. For a more complete and older updates, please refer to the package [changelog](https://pub.dev/packages/flex_color_scheme/changelog).
...
This release **requires** at least Flutter 3.3.0 and Dart 2.18.0. It uses theming features in 
Flutter SDK that do not exist in earlier versions.
