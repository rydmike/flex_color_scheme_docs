...
This beta-1 of FlexColorScheme v7.1.0, is a dev release using Flutter 3.10 beta channel. It requires Flutter version 3.10.0-1.3.pre or later. This beta version is a first preparation version of FlexColorScheme for the next stable Flutter release after version 3.7.x. The SKIA canvaskit renderer is again being used to build all the web examples, including the Themes Playground.

The [**Themes Playground**]((https://rydmike.com/flexcolorscheme/themesplayground-v7-1)) tutorial and example apps built and using FlexColorScheme v7.1.0-dev.1 can be found here:
...
Read more in the 7.1 beta-1 [changelog](https://pub.dev/packages/flex_color_scheme/versions/7.1.0-dev.1/changelog).
