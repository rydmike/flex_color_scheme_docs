...
Version 3 was the first release with a Tweet thread summary. It was also the first major release after the null-safety upgrade that came with version 2.0 a bit earlier, March 15, 2021. The only breaking change was removing `accentColor`, that was getting deprecated in Flutter SDK.

[<img src="https://raw.githubusercontent.com/rydmike/flex_color_scheme_docs/master/docs/images/fcs-v3-tweet.jpg" width="400"/>](https://twitter.com/RydMike/status/1408863960514895873)

Version 3 also added four new color schemes **Bahama and trinidad**, **Mallard and valencia**, **Espresso and crema** and **Outer space stage**. A minor new feature allowing swapping primary and secondary colors in a scheme with a quick setting was also added.
